...
**先看 [08 Prompt 优化报告第二轮定稿](08-Prompt优化报告-第二轮定稿.md) 和 [07 第一部分架构](07-第一部分架构-产品与技术.md)。** 当前没有逐维验收通过的最终 Prompt。下面01—05、p13与其语言策略属于第一轮快照；它们不代表新一轮已经完成。

其他 agent 请读 [接手入口与恢复命令](../studies/round2/HANDOFF.md)，接手计划和当前进度均已保存。本目录按以下用途阅读。

| 文件 | 用途 |
|---|---|
| [08 Prompt 优化报告第二轮定稿](08-Prompt优化报告-第二轮定稿.md) | 口径、基线处理、候选谱系、完整回归与留出、评审与未通过项 |
| [07 第一部分架构](07-第一部分架构-产品与技术.md) | 产品视角对 PRD 3.1 逐条，技术视角五层约束、接口与差异清单 |
